...
- project download loader

## 0.75.1 (2024-12-25)

### Fix

- popover status check
...
- delete report only for draft stage
- new report check if id exist in response
- moderation table report preview
- report form double cell save old format
- new report handler
- report sections
- sections check
- dobule old format save, view required in report sections
- report section loading
- sidebar count
- stages text
- sidebar
- moderation popover
- sidebar reports moderation count
- label cell placeholder
- delete validate on sumbit report
- recovery password redirect
- moderation redirect
- delete section load if no data changed
- form table file cell rules
- update sections status after report generated
- rework files inputs
- purchases table buttons
- section validation on save
- form file uploader reports
- report preview
- validate sections
- save report section
- report generation wait on ready status
- report docx, report delete
- generate docx project double cell
- double cell checker
- purchase monitoring table
- next tab isEdit
- user guide
- report sections
- less validation
- reports table
- edit project next tab
- build
- more safe generate docx
- monitoring no wrap value
- safe count
- moderator project reworking return
- changes index
- recovery password
- form table date cell format
- table date cell
- project discussion wrapper
- build error
- safe download from double click, moderation spin on download
- purchase monitoring filters
...
- fam project reworking tabs disabled
