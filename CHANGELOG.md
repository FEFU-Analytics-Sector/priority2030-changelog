...
## 2.6 (2024-12-23)
### Нововведения:
- Отчеты по проектам. В руководстве пользователей добавлена информация о том, как с ними работать. Отчеты формируются на основе раннее утвержденных проектов в текущем году, автоматически подтягивают данные оттуда. Руководителю проекту остается лишь заполнить фактические значения и загрузить подтверждающие документы. Это очень крупное обновление, изменившее техническую начинку работы с контентом.
- Новые роли: модератор-проректор. Имеют обычные права с возможностью модерировать отчеты, если их выбрали.
