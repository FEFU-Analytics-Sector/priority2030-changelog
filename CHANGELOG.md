...
- Теперь при обновлении страницы в проекте или отчете раздел не будет сброшен на стартовый, а сохранится тот, в котором вы только что работали. Аналогичный метод применен и к таблице модерации при переключени по этапам.
