...
## 0.91 (2023-11-13)
### Нововведения
- Проекты: базовое редактирование. Изменение проектов, находящихся в реализации, приведут к повторной модерации, но не потребуют полного круга прохождения. Достаточно только подтверждения от всех модераторов. В дальнейшем модерировать будут только те модераторы и те секции, которые были изменены владельцем проекта.
