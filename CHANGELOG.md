...
## 1.3 (2024-02-21)
### Нововведения
- История модерации проекта. Доступа руководителю и модераторам в окне модерации.
...
- Новый показатель ПРГ3. Доступен при создани и нового проекта, не применяется к старым.
...
- Мстория версий проекта доступна для модераторов при модерации проекта по кнопке в меню.
...
### Нововведения
- переработаны ссылки и номера документов: добавлены года в конце в связи с возможными дубликатами в ЗНО. Для ЗНО нумерация документов идёт в пределах года, поэтому в разные года может совпать номер документа.
