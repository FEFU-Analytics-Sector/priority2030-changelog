...
### Нововведения
 - добавлена страница "База знаний", содержщая ссылки на презентации с инструкциями по работе с системой и прочими документами по программе "Приоритет 2030".

 ### Исправления
 
  - баг, при котором не отправлялся проект на модерацию если последняя секция была исправлена и горела желтым цветом, как секция с ошибками.
