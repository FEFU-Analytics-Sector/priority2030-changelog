...
## 2.9 (2025-03-02)
### Нововведения:
 - Фукнция перевода проекта в статус "Завершено" для модераторов ПО доступна через контекстное меню в списке проектов.
 - Админ-панель: реализация фильтров, поиска и пагинации на стороне сервера.
 - Админ-панель: теперь при смене или добавлении роли пользователю она сразу же отобразится в таблице ролей. Добавлен механизм назначения руководителей стратегий и политик.
 - Новый интерфейс уведомлений, добавлены уведомления через телеграм-бота.
### Исправления:
- Переработана техническая составляющая метода создания и работы с проектами. Исправлены ошибки отображения значений и взаимодействие в зависимости от роли.
- Баг с неправильным отображением значений отчетов в меню и таблице модерации отчетов. Просмотренные теперь не учитываются в подсчете.
- Теперь поле ввода комментария сбрасывается после отправки текста.

 ---

## 2.8 (2025-02-10)
### Нововведения:
 - В модерации проектов и отчетов при наведении на кружок вердикта под разделом добавлен тултип с выбором вердикта.
...
- Применен часовой пояс в листе согласования.
...
- Множество других технических изменений. Это очень крупное обновление, которое изменило техническую составляющую работы с данными проектов и отчетов.
